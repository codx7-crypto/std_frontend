...
useEffect(() => {
  ...
  return (
    ...
    <div className="parent">
      ...
      >
        <source src="https://res.cloudinary.com/dsijn95el/video/upload/v1751035637/qsr9cteknbubatnknep7.mp4" type="video/mp4" />
    ...
    <section id="aboutus" className="about-section">
      <div className="about-content">
        ...
        بخبرة مستمدة من التجربة والتميّز، تأسست <strong>النورس التعليمية</strong>, لتكون نقطة انطلاق نحو مستقبل أكاديمي واعد للطلاب العرب والدوليين في تركيا. ومنذ انطلاقتها، وضعت النورس في صميم رسالتها أن تكون من المؤسسات الرائدة في تقديم الاستشارات الأكاديمية المتخصصة، ومرافقة الطلاب خطوة بخطوة في رحلتهم التعليمية.
          <br /><br />
          توسّع عمل <strong>النورس التعليمية</strong> ليشمل العديد من المدن التركية، وعلى رأسها إسطنبول، حيث أصبح اسمها معروفًا لدى الجامعات التركية ومراكز التعليم المعتمدة، مدعومًا بفريق متميز من المستشارين الأكاديميين ذوي الكفاءة والخبرة الطويلة في هذا المجال.
          <br />
          تُقدّم النورس التعليمية خصومات حصرية ومنح دراسية مميزة في أكثر من 50 جامعة تركية معتمدة، لجميع المراحل التعليمية:
          الدبلوم، البكالوريوس، الماجستير، والدكتوراه، وذلك من خلال نظام إلكتروني متكامل يضمن للطلاب تسجيلًا سهلًا ومضمونًا.
          <br />
          <strong>النورس التعليمية</strong> ليست مجرد وسيط، بل شريك حقيقي في النجاح الأكاديمي، ومصدر ثقة لكل طالب يسعى للتميّز في رحلته الدراسية في تركيا.
        </p>
      </div>
